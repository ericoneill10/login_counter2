...
class TestAddUser(testLib.RestTestCase):
    ...
    def testLongPassword(self):
        longName = 'a' * 200
        respData = self.makeRequest("/users/add", method="POST", data = { 'user' : 'user', 'password' : longName} )
        self.assertResponse(respData, None, errCode = -4)
